 ...
 * define the queueing network model details, call the solvers transparently
 * and, afterwards, read the results.
 *
...
public class SolverMultiClosedCoMoM extends SolverMulti {
	...
	protected Integer scale = 100000;
