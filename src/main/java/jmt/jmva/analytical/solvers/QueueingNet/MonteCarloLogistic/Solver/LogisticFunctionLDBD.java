...
import static jmt.jmva.analytical.solvers.Utilities.MiscFunctions.exp;
import static jmt.jmva.analytical.solvers.Utilities.MiscFunctions.log;
 ...
 */
public class LogisticFunctionLDBD extends LogisticFunctionBase {
	...
	public Function copy() throws InternalErrorException {
		return new LogisticFunctionLDBD(this);
	}
	...
	public void calculate_stationary_point() throws InternalErrorException {
		...
		class LFMS1D_grad implements MultivariateVectorFunction {
			...
			private LogisticFunctionLDBD LFMS;
			...
			public LFMS1D_grad(int ndim, DoubleMatrix1D population, DoubleMatrix2D demands, DoubleMatrix1D servers, double epsilon) throws InternalErrorException {
				LFMS = new LogisticFunctionLDBD(ndim, population, demands, servers, epsilon);
			}
	...
	/*================ Constructors =================*/
	public LogisticFunctionLDBD(int ndim, int[] population, double[][] demands, double[] servers, double epsilon) throws InternalErrorException {
		this(ndim, population, demands, servers, epsilon, MathContext.DECIMAL128);
	}

	public LogisticFunctionLDBD(int ndim, DoubleMatrix1D population, DoubleMatrix2D demands, DoubleMatrix1D servers, double epsilon) throws InternalErrorException {
		this(ndim, population, demands, servers, epsilon, MathContext.DECIMAL128);
	}

	public LogisticFunctionLDBD(int ndim, DoubleMatrix1D population, DoubleMatrix2D demands, DoubleMatrix1D servers, double epsilon, MathContext MC) throws InternalErrorException {
		super(ndim);
		this.initialize(ndim, population, demands, servers, epsilon, MC);
	}

	public LogisticFunctionLDBD(int ndim, int[] population, double[][] demands, double[] servers, double epsilon, MathContext MC) throws InternalErrorException {
		super(ndim);
	...
	/*Copy constructor*/
	public LogisticFunctionLDBD(LogisticFunctionLDBD LF) throws InternalErrorException {
