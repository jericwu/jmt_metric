 ...
 * <p><b>Name:</b> Parser</p> 
 * <p><b>Description:</b> 
 * Simple Java arithmetic expression parser and ELL(1) grammar syntactical analyzer and evaluator.
...
public class Parser {
	...
	// if not in a simulation, the default engine used
	...
	private ExpressionNode U() {
		switch (cc.getToken()) {
			...
			case FUNC:
				...
				FunctionNode fn = new FunctionNode(tmp2, function);
				fn.setParser(this); 
				return fn;
		}
