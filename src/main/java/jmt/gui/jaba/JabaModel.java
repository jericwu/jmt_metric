...
public class JabaModel implements JabaConstants {
	...
	/**
	 * queue length dim: queueLen[stations][classes+1]
	 */
	...
	/**
	 * residence times dim: resTimes[stations+1][classes+1]
	 */
	...
	public void setServiceTimes(double[][][] serviceTimes) {
		...
		for (int s = 0; s < stations; s++) {
			...
			// if the station is LD but there are no jobs, totalPop = 0
			if (currSize == 0) {
				currSize = 1;
			}
	...
	/**
	 * @return the sizes of service times for each station (total pop for LD
	...
	public String toString() {
		...
		s.append("stations=").append(stations).append(" classes=")
				.append(classes).append(" pop=").append(totalPop)
	...
	/** Returns per-station aggregate for utilization */
	...
	/** Returns global aggregate for utilization */
